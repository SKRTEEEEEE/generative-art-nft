...
### MOD: commit -> generative-metadata-nft

Modificated the metadata.py script for have the metadata for a created group of images.
¡For a group of images that you have created without metadata!

> For crate the NFTs images, using "capas", use the original commit from scrappysquirrels
...
In generative-metadata-nft commit we have a version of the metadata.py script that allows you create metadata from a group of images created yet. Not for images created with nft.py!
